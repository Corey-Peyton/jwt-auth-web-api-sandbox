...
/* 	---------------------------
	...
	---------------------------
*/ 
-- Suppression des tables : T_CATEGORIES, T_CATEGORIES_T_PRODUCTS, T_IMAGES, T_PRODUCTS
...
-- Contrainte de la clé étrangère : IMAGE_ID dans la table d'association T_PRODUCTS
ALTER TABLE T_PRODUCTS 
	ADD CONSTRAINT FKmap8flyi66wx3urs4qywuorqj 
