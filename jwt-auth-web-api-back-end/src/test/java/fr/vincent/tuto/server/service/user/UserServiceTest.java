...
@ContextConfiguration(name = "userServiceTest", classes = { BackEndServerRootConfig.class, DatabasePropsService.class, PersistenceContextConfig.class, UserService.class })
@SpringBootTest
@ActiveProfiles("test")
