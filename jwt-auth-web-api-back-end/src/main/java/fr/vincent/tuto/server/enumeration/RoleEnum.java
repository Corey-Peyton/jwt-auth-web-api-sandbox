...
{
    ROLE_USER, // Utilisateur authentifié et disposant des autorisations complètes sur les données : utilisateurs, produits, catégorie,
               // indice=0.
    ROLE_ADMIN, // dispose des autorisations complètes sur l'ensemble des données, indice=1.
    ROLE_MODERATOR, // Gestionnaire des produits dispose des autorisations sur les données des produits et leur catégorie, indice=2.
